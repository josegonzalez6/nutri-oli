...
- Fundacion inicial de Nutri-Oli.
- Next.js, TypeScript, i18n, Tailwind, Supabase local, RLS, CI y documentacion base.
- Catalogo profesional de alimentos con import BEDCA local, esquema Supabase y RLS.
